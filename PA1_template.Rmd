...
Mean (without NAs) = `r mean_steps_daily` vs. Mean (with filled NAs) = `r mean_steps_daily_f`  
Median (without NAs) = `r median_steps_daily` vs. Median (with filled NAs) = `r median_steps_daily_f`
